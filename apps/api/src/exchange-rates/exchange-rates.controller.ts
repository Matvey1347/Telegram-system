...
export class ExchangeRatesController {
  ...
  @Post() create(@CurrentUser() user: JwtUser, @Body() dto: CreateExchangeRateDto) { return this.service.create(user.sub, dto); }
  @Patch(':id') update(@CurrentUser() user: JwtUser, @Param('id') id: string, @Body() dto: UpdateExchangeRateDto) { return this.service.update(user.sub, id, dto); }
